...
Select CUS_GENDER, count(CUS_NAME) as "Total Counts" from CUSTOMER 
inner join
...
as Q ON PRODUCT_DETAILS.PROD_ID=Q.PROD_ID) as P ON PRODUCT.PRO_ID=P.PRO_ID) as output ON CATEGORY.CAT_ID=output.CAT_ID;
